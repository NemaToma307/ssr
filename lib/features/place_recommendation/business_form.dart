...
import 'package:ssr_project/features/place_recommendation/logic/form_cubit.dart';
...
class _businessFormState extends State<businessForm> {
  ...
  List<String>? selectedItemsOptionsOne;
  List<String>? selectedItemsOptionsTow;
      ...
      child: BlocConsumer<FormCubit, FormStates>(
          listener: (BuildContext context, state) {
            if (state is FormErrorState) {
              ...
              // });
              // return Builder(
              //     builder: (BuildContext builderContext) {return});
             // fillBlank(context);
            }
            if(state is FormSuccessFillState){
              AwesomeDialog(
                width: 500,
                context: context,
                dialogType:
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(children: [
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  // onChanged: (val){
                                  //   setState(() {
                                  //     businessNameController.text = val;
                                  //   });
                                  // },
                          ...
                          const SizedBox(height: 25.0),
                          smallTitle(
                              'Rental Budget for month', smallGrayTextStyle),
                          SizedBox(
                            width: 800,
                            child: Slider(
                          ...
                          const SizedBox(height: 50),
                          bidTitle(
                              'Accessibility Preference', smallBlueTextStyle),
                          const Divider(),
                          const SizedBox(height: 25.0),
                          Row(
                            children: [
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return upCheck(
                                      options[index]["title"],  // Pass title
                                      options[index]["isChecked"],  // Pass isChecked value
                                      index,  // Pass index to modify the list
                                    );
                          ...
                          SizedBox(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return downCheck(
                                  options2[index]["title"],  // Pass title
                                  options2[index]["isChecked"],  // Pass isChecked value
                                  index,  // Pass index to modify the list
                                );
                            ...
                            Container(
                              ...
                              child: TextButton(
                                ...
                                onPressed: () {
                                  ...
                                  print( maxValueRange);
                                  print( '******');
                                  selectedItemsOptionsOne =
                                  options.where((item) => item["isChecked"] == true)
                                         .map((item) => item["title"] as String)
                                         .toList();
                                   selectedItemsOptionsTow =
                                  options2.where((item) => item["isChecked"] == true)
                                          .map((item) => item["title"] as String)
                                          .toList();

                                  print(selectedItemsOptionsOne);
                                  print('----------------------');
                                  print(selectedItemsOptionsTow);

                                  businessNameController.text.isEmpty ||
                                      maxValueRange == 0    ||
                                      dropDownValue == null ||
                                      selectedItemsOptionsOne!.isEmpty ||
                                      selectedItemsOptionsTow!.isEmpty ||
                                      statusValue == null
                                   ?  showDialog(
                                      context: context,
                                  ...
                                  // FormCubit.get(context).validateForm(
  ...
  Widget upCheck(text,isChecked, index1) => Container(
        width: 300,
            ...
            Padding(
              ...
              child: Checkbox(
                ...
                onChanged: (bool? value) {
                  setState(() {
                    options[index1]["isChecked"] = value!;
                  });
                  print(options[index1][text]);
                  // setState(() {
                  //   //index2 = value!;
                  //   index2 = !index2;
                  //   print(index2);
  ...
  Widget downCheck(text,bool isChecked , index2) => SizedBox(
        width: 300,
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Checkbox(
                ...
                onChanged: (bool? value) {
                  setState(() {
                    options2[index2]["isChecked"] = value!;
                  });
                  print(options2[index2][text]);
                },
              ),
            ],
          ),
